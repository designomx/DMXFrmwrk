...
// subject
$subject = 'Contratacion de plan en EligeFacil.com';
...
$message.='<p>Plan:</p><p>'.$_POST["empresa_plan"].' '.$_POST["nombre_plan"].' (id:'.$_POST["id_plan"].')</p>
<p>Telefono Contacto:</p><p>'.$_POST["telefono"].' movil:'.$_POST["movil"].'</p>
