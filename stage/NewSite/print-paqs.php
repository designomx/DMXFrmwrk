...
<html lang="es">
	...
	<body>
		<div class="row print-details-bx">
			<?php
			if(isset($_GET['plan'])){
				foreach($_GET["plan"] as $Id_plan)
				{
					//Saber si es $Servicio_celular o no, para mostrar los celulares
					$query_tipo_servicio=("SELECT * FROM planes_tipoServicios WHERE id_plan=".$Id_plan);
					...
					{
						echo '<div class="col s12 m6 deatilsModal">
								<div class="modal-content">
									<a href="index.php" class="logo-header"><img src="images/logo_eligefacil.png" width="159" alt=""  style="margin: 0 auto; position: relative; display: block;"/></a>
