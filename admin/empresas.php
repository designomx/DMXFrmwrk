	...
	function showPopupWindow(caller, transaccion, id_empresa){
		...
		switch(transaccion){
			...
			case "INSERT":
				...
				$popUpWindowTitle.html("<h4>Nueva Empresa</h4>");
			...
			case "UPDATE":
				...
				// Asignamos los valores conocidos.
				$popUpWindowTitle.html("<h4>Editar Empresa</h4>");
	...
	function cargarEstados(){
		$.ajax({
			...
			{				
				...
				$('#SelectEstadosEditar select').attr("id","selectEstadoEditar");
			}
		});
	}
	...
	<input type="hidden" name="transaccion" id="transaccion" value="">
      ...
      <table class="form" border="0" cellspacing="0" cellpadding="5">
        <tr class="titulopopup">
          <td id="title" colspan="2" class="center titulopopup"></td>
        </tr>
        <tr>
      ...
      <div class="formContacto">
			...
			<table class="striped ">
				<thead>
					<tr>
						...
						<th data-field="accion">Eliminar</th>
					</tr>
				</thead>
   	  ...
   	  <div class="row col s12">
   	  	<button id="mas_contactos" onclick="$('select').material_select();" class="modal-trigger waves-effect waves-light btn col s12" href="#modalPreview">Agregar Datos de contacto</button>
   	  </div>
	    ...
	    <div id="SelectEstados">
	    	...
	    	<div class="row"> <br><br><br>
			    <form class="col s12" id="RegistrarContactoEmpresa">
					...
					<div class="row col s12">
						<a class="waves-effect waves-light btn col s12" onclick="mas_correos('INSERT','ADD');"><i class="material-icons right">+</i>Agregar Correo</a>
					</div><br>
					...
					<div class="row col s12">
						<a class="waves-effect waves-light btn col s12" onclick="mas_telefonos('INSERT','ADD');"><i class="material-icons right">+</i>Agregar Telefono</a>
					</div>
					...
					<div class="row col s12">
						<a class="waves-effect waves-light btn col s12" onclick="mas_enlaces('INSERT','ADD');"><i class="material-icons right">+</i>Agregar Enlace</a>
					</div>
			    </form>
		  	</div>
	  	</div>
	    ...
	    <div id="SelectEstadosEditar">
	    	...
	    	<div class="row">
			    <form class="col s12" id="RegistrarContactoEmpresa">
					...
					<div class="row col s12">
						<a class="waves-effect waves-light btn col s12" onclick="mas_correos('INSERT','EDIT');"><i class="material-icons right">+</i>Agregar Correo</a>
					</div>
					...
					<div class="row col s12">
						<a class="waves-effect waves-light btn col s12" onclick="mas_telefonos('INSERT','EDIT');"><i class="material-icons right">+</i> Agregar Telefono</a>
					</div>
					...
					<div class="row col s12">
						<a class="waves-effect waves-light btn col s12" onclick="mas_enlaces('INSERT','EDIT');"><i class="material-icons right">+</i>Agregar enlace</a>
					</div>
			    </form>
		  	</div>
	  </div>
